...
usage: serverless component create`,
        ...
        properties: {
          name: {
            ...
            conform:     function(componentName) {
              return _this.S.classes.Component.validateName(componentName);
            }
          }
        }
      };
    ...
    _createComponent() {
      ...
      this.component  = new this.S.classes.Component(
        this.S,
        this.S.getProject(),
        {
        ...
        this.S.getProject().getRootPath(this.evt.options.name, 's-component.json')
      );
      ...
      return BbPromise.try(function() {
        ...
        if (_this.evt.options.runtime === 'nodejs') {
          ...
          let packageJsonTemplate = SUtils.readFileSync(path.join(_this.S.getServerlessPath(), 'templates', 'nodejs', 'package.json')),
            libJs = SUtils.readFileSync(path.join(_this.S.getServerlessPath(), 'templates', 'nodejs', 'index.js'));
    ...
    _installComponentDependencies() {
      return( this.component.getRuntime().installDependencies( this.evt.options.name ) );
    }
  }
